...
**************************************************************************/
require_once(cAppGlobals::$root."/inc/renderqs.php");
require_once(cAppGlobals::$root."/inc/rendermenus.php");
require_once(cAppGlobals::$root."/inc/renderobjs.php");
require_once(cAppGlobals::$root."/inc/renderhtml.php");

...
cRenderCards::body_start();
	$aMetrics = [];
	$aMetrics[] = [cChart::LABEL=>"$oTier->name - Calls per min",cChart::METRIC=>cADTierMetrics::tierExtCallsPerMin($oTier->name,$sExt)];
	$aMetrics[] = [cChart::LABEL=>"$oTier->name - Response time in ms", cChart::METRIC=>cADTierMetrics::tierExtResponseTimes($oTier->name,$sExt)];

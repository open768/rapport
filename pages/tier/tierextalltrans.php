...
cRenderCards::body_start();
	$aMetrics = [];
	$aMetrics[] = [cChart::LABEL=>"$oTier->name - Calls per min",cChart::METRIC=>cADTierMetricPaths::toTierCallsPerMin($oTier->name,$sExt)];
	$aMetrics[] = [cChart::LABEL=>"$oTier->name - Response time in ms", cChart::METRIC=>cADTierMetricPaths::toTierResponseTimes($oTier->name,$sExt)];

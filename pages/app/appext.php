...
cRendercards::body_start();
	$aMetrics = [];
	$aMetrics[] = [cChart::LABEL=>"Calls per min",cChart::METRIC=>cADAppMetrics::appCallsPerMin()];
	$aMetrics[] = [cChart::LABEL=>"Response Time",cChart::METRIC=>cADAppMetrics::appResponseTimes()];
